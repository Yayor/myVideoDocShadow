...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.LOSS = CN()
        self._C.LOSS.SHADOW = 1.0
        self._C.LOSS.IDENTITY = 0.5
        self._C.LOSS.EDGE = 0.1
        self._C.LOSS.CHROMA = 0.3
        self._C.LOSS.TV = 0.01
        self._C.LOSS.LOWFREQ_KERNEL = 15
        self._C.LOSS.MASK_BLUR = 9

        self._C.TESTING = CN()
        self._C.TESTING.WEIGHT = None
        self._C.TESTING.SAVE_IMAGES = False
        self._C.TESTING.CHROMA_SAFE = False
